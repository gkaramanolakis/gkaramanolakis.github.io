...
\item 
    ...
    \begin{itemize}
        \item Carried out research and developed code in the context of ``Audio Analysis for Soundscape Event Detection and Quality Estimation using Machine Learning Methods''.
