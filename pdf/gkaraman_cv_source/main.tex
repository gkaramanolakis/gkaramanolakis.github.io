...
\usepackage{titlesec}
\titleformat{\section}
  {\rmfamily\mdseries\Large}{\thesection}{1em}{}[{\titlerule[0.5pt]}]
...
\item 
    ...
    %\item[-] Grounded natural language semantics to the auditory and visual sensory modalities.
...
\cite{karamanolakis2019cotraining}

\cite{karamanolakis2019seedwords}

\cite{gero2018transfer}
...
\begin{itemize}
\item \textbf{Leventis Foundation Scholarship}, New York, US \hfill 08/2019
...
\item \textbf{Hellenic Mathematic Society ``Euclides'' \& ``Thales''  Awards}, Sitia, Greece \hfill 02/2009, 03/2010
