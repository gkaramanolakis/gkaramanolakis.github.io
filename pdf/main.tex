...
\begin{itemize}
  \item
    ...
    Active Involvement in: %\href{https://datascience.columbia.edu/}{Data Science Institute}, 
    ...
    %Active Participation in: Database Research Group (CUDBG), Natural Language Processing Group
